        ...
        <template #default>
          <div class="demo-rich-conent" style="display: flex; gap: 16px; flex-direction: column">
            <div class="demo-rich-conent-custom">
              <!-- 用户没设置头像的情况下使用系统默认的 -->
              <img v-if="userInfo.userIcon" style="width: 40px;border-radius: 50px;"
                :src="url + 'uploadFile/' + userInfo.userIcon" />
              <img v-else style="width: 40px;border-radius: 50px;" src="../../../assets/default_avatar.png">
              ...
              <p class="demo-rich-content__mention">
                注册时间：{{ formatTime('{0}-{1}-{2} {3}:{4}:{5}', userInfo.createTime) }}
              </p>
            </div>
