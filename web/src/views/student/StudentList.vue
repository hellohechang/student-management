...
<!--新增学生弹出框 start-->
<el-dialog  align-center v-model="addStudentDialogFormVisible"  width="90%" style="max-width: 650px;" destroy-on-close>
  ...
  <!--编辑学生弹出框 start-->
  <el-dialog  align-center v-model="editStudentDialogFormVisible"  width="90%" style="max-width: 650px;" destroy-on-close>
    <template #header="{ close, titleId, titleClass }">
      <div class="my-header">
        <el-icon size="26px"><EditPen /></el-icon>
...
import {deleteStudentApi, getStudentApi, getStudentListApi} from "../../api/student"
