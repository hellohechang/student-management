<template>
  ...
  <div class="dialong__button--wrap">
    ...
    <el-button color="#178557" :loading="subLoading" type="success" @click="addGradeClass(ruleFormRef)">保存</el-button>
  </div>
</template>

<script setup>
import {ref, reactive} from 'vue'
import {addGradeClassApi} from "../../../api/gradeclass";
...
// 新增班级信息
const addGradeClass = async (formEl) => {
  if (!formEl) return
