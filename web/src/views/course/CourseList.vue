<template>
        ...
        <el-table-column label="操作">
          <template #default="scope">
            ...
            <el-popconfirm confirm-button-text="确定" cancel-button-text="取消" :icon="Delete"
                           icon-color="#626AEF" :title="'确定删除课程名为“'+scope.row.course_name+'”的课程吗？'"
  ...
  <!--新增课程弹出框 start-->
  <el-dialog  align-center v-model="addCourseDialogFormVisible"  width="90%" style="max-width: 650px;" destroy-on-close>
  ...
  <!--编辑课程弹出框 start-->
  <el-dialog  align-center v-model="editCourseDialogFormVisible"  width="90%" style="max-width: 650px;" destroy-on-close>
    <template #header="{ close, titleId, titleClass }">
      <div class="my-header">
        <el-icon size="26px"><EditPen /></el-icon>
...
import {deleteCourseApi, getCourseApi, getCourseListApi} from "../../api/course";
