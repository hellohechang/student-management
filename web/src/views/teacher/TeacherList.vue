<template>
  ...
  <!--新增教师弹出框 start-->
  <el-dialog  align-center v-model="addTeacherDialogFormVisible"  width="90%" style="max-width: 650px;" destroy-on-close>
  ...
  <!--编辑教师弹出框 start-->
  <el-dialog  align-center v-model="editTeacherDialogFormVisible"  width="90%" style="max-width: 650px;" destroy-on-close>
    <template #header="{ close, titleId, titleClass }">
      <div class="my-header">
        <el-icon size="26px"><EditPen /></el-icon>
...
import {deleteTeacherApi, getTeacherApi, getTeacherListApi} from "../../api/teacher"
