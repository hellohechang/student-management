<template>
    ...
    <div class="table-box">
      <el-table element-loading-text="数据加载中..." v-loading="loading" :data="tableData"
        ...
        <el-table-column label="操作">
          <template #default="scope">
            <el-button size="small" @click="editRole(scope.row.id)" style="margin: 0 0 10px 10px;">编辑</el-button>
            <el-popconfirm width="200px" confirm-button-text="确定" cancel-button-text="取消" :icon="Delete"
              icon-color="#626AEF" :title="'确定删除角色名为“' + scope.row.name + '”的角色吗？'" @confirm="delRole(scope.row.id)">
              <template #reference>
  ...
  <!--新增角色弹出框 start-->
  <el-dialog align-center v-model="addRoleDialogFormVisible" style="max-width: 650px;" width="90%" destroy-on-close>
  ...
  <!--新增角色弹出框 end-->
  <!--编辑角色弹出框 start-->
  <el-dialog align-center v-model="editRoleDialogFormVisible" style="max-width: 650px;" width="90%" destroy-on-close>
    <template #header="{ close, titleId, titleClass }">
      <div class="my-header">
        <el-icon size="26px">
          <EditPen />
...
import { deleteRoleApi, getRoleApi, getRoleListApi } from "../../api/role";
